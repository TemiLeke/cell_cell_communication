# Sys.setenv(RETICULATE_PYTHON = "/home/tadeoye/miniconda3/envs/scRNA_seq_meta_analysis/bin/python3")
# library(reticulate)
# use_python('/home/tadeoye/miniconda3/envs/scRNA_seq_meta_analysis/bin/python3',required = T)

invisible(ulimit::memory_limit(1000000))

# source('../scripts/functions/PASBench/R/example.R')
# source('../scripts/functions/PASBench/R/metrics.R')
# source('../scripts/functions/PASBench/R/scalability.R')
# source('../scripts/functions/PASBench/R/stability.R')
source('../scripts/functions/PASBench/R/tools.R')
